...
#include "../../../../../../networking/socket programming/CQt/test/D/threadGui/myThread.h"
...
QT_MOC_LITERAL(1, 9, 13), // "screenDisplay"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "myThread\0screenDisplay\0"
};
...
void myThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->screenDisplay((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myThread::screenDisplay)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myThread::screenDisplay(QString _t1)
{
